...
const CACHE_VERSION = 'interplanet-v1.17.0';

const SHELL_URLS = [
  '/',
  '/index.html',
  '/sky.js?v=1.17.0',
  '/planet-time.js?v=1.17.0',
  '/assets/sky.css?v=1.17.0',
  '/assets/i18n.js?v=1.17.0',
  '/assets/holidays-data.js?v=1.17.0',
  '/assets/un-days.js?v=1.17.0',
  '/ltx.html',
  '/dashboard.html',
  '/playground.html',
  '/events.html',
